...
function menuRegistrarAnalisis(){
...
function menuAprobarEnviarInforme(){
...
function menuFacturacion(){
    ...
    document.getElementById('menuRegistrarAnalisis').style.display = 'none';
    document.getElementById('menuAprobarEnviarResultados').style.display = 'none';
    document.getElementById('menuFacturacion').style.display = 'block';
    document.getElementById('menuInteligenciaNegocio').style.display = 'none';
    document.getElementById('menuPortalCliente').style.display = 'none';
}

function menuInteligenciaNegocio(){
    ...
    document.getElementById('menuAprobarEnviarResultados').style.display = 'none';
    document.getElementById('menuFacturacion').style.display = 'none';
    document.getElementById('menuInteligenciaNegocio').style.display = 'block';
    document.getElementById('menuPortalCliente').style.display = 'none';
}

function menuPortalCliente(){
    ...
    document.getElementById('menuFacturacion').style.display = 'none';
    document.getElementById('menuInteligenciaNegocio').style.display = 'none';
    document.getElementById('menuPortalCliente').style.display = 'block';
}
